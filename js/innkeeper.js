...
var Inn = {
	...
	//functions
	startNightShift: function (callbackWhenTickComplete, callbackFunctionWhenComplete) {
		var self = this;
		...
		var executeAnotherTickAsync = function () {
			...
			self.executeOneNightShiftTick(currentTick, callbackWhenTickComplete);
			++currentTick;
	...
	executeOneNightShiftTick: function (tickNumber, callbackWhenCompleted) {
		...
		if (callbackWhenCompleted)
			callbackWhenCompleted.call(this, tickNumber);
	}
};
